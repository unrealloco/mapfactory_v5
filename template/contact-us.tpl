    ...
    <div id="colCenter">
        <div class="niceText" id="textZone">
                    <h1>You want to CONTACT US ?</h1>
                    <p id="contact_introduction">Simply fill up this form, we'll give you an aswer as soon as possible.</p>

                    <form id="contactUs" name="contactus" action="javascript:contactUs();">
